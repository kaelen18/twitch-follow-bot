...
token = 'ODM2NjY2MDY1NjQyODQ4MzE3.YIhT_g.pr7Qw98Du7E6p7JX8YfdcHNKtTE'
prefix = '/'
...
administrators = ['834573801680666645']
chat_channel = 834612950357901395
bots_channel = 834612950357901395
...
async def on_member_join(member):
    ...
    await channel.send(f'Welcome to **Bloom**, {member.mention}.\nType `/help` to get started!')
